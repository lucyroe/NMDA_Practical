%% FIRST LEVEL GLM SWITCH

% Function name: glm_1stlevel_switch_job
% Description: This script runs a first-level glm (only) over all 6 runs & the two conditions (alt vs. sim).
...
function glm_1stlevel_switch4reg_job(datapath_nifti, runs, run_logs, conditions_runs, contrastvec0, outputfolder_1stlevel_switch4reg)

clear matlabbatch

smoothed_imgpaths = cell(length(runs), 1);

matlabbatch{1}.spm.stats.fmri_spec.dir = {outputfolder_1stlevel_switch4reg};
...
% CONTRAST MANAGER 
matlabbatch{3}.spm.stats.con.spmmat = {[outputfolder_1stlevel_switch4reg filesep 'SPM.mat']};

matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = conditions_runs{2};
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = contrastvec0{1}; % phase sim
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = conditions_runs{1};
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = contrastvec0{2}; % phase alt
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'switch_sim';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = contrastvec0{3}; % switch sim 
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'switch_alt';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = contrastvec0{4}; % switch alt
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';

matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'switch';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = contrastvec0{5}; % switch alt
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
